...
class FreshChromiumBasedInterceptor {
  ...
  async activate(proxyPort, options) {
    ...
    // await hideWarningServer.start(staticConfig.PROXY_TEST_PAGE_URL);
    ...
    // custom theme
    launchOptions.options.push(`--install-autogenerated-theme=23,94,242`);
    const browser = await launchBrowser(
      // hideWarningServer.hideWarningUrl,
      staticConfig.PROXY_TEST_PAGE_URL,
      launchOptions,
