...
export enum USER_PREFERENCE {
  ...
  GET_PROXY_CHAINS = "USER_PREFERENCE:GET_PROXY_CHAINS",
  SET_PROXY_CHAINS = "USER_PREFERENCE:SET_PROXY_CHAINS",
  GET_WIREGUARD_CONFIGS = "USER_PREFERENCE:GET_WIREGUARD_CONFIGS",
  SET_WIREGUARD_CONFIGS = "USER_PREFERENCE:SET_WIREGUARD_CONFIGS",
  GET_ROUTE_OVERRIDES = "USER_PREFERENCE:GET_ROUTE_OVERRIDES",
  SET_ROUTE_OVERRIDES = "USER_PREFERENCE:SET_ROUTE_OVERRIDES",
